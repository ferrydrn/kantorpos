  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="barang-tambah.php">Tambah Data Barang</a>
        </li>
        <li class="nav-item">
...
<!-- Tabel -->
<section>
<h1 class="fw-bold"><center>Tambah Data Barang</center></h1>
<hr>
<form method="post" name="frm" action="barang-simpan.php">
<div class="container table-responsive">
<table class="table table-sm table-bordered mt-3">
<tr><td><b>KODE BARANG</b></td>
